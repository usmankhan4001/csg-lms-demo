...
const TAG_LABELS: Record<string, string> = {
  admin: 'Headless LMS',
  'sms-admissions': 'SMS Admissions CRM',
  'sms-matriculation': 'Matriculation Handshake',
  'sms-academic': 'Academic Structures',
  'EMS Academic Curricular Bridge': 'Curricular Bridge',
  'sms-timetable': 'Timetable & Bell Schedules',
  'sms-attendance': 'Biometric Attendance',
  'sms-gradebook': 'Gradebook & SpeedGrader',
  'sms-exams': 'CBT Exams & Psychometrics',
  'ems-academic-exams': 'Psychometric Analytics',
  'sms-fees': 'Fee Billing & Vouchers',
  'sms-fee-payments': 'Payment Gateway Callbacks',
  'sms-financials': 'General Ledger & Accounts',
  'sms-payroll': 'Progressive Payroll',
  'sms-hr': 'Faculty & Staff HR',
  'sms-pastoral': 'Pastoral Care',
  'sms-counseling': 'Clinical Desk (Encrypted)',
  'sms-cognia': 'Cognia Accreditation AMI',
  'sms-library': 'School Library',
  'sms-discipline': 'Discipline Logs',
  'sms-alumni': 'Alumni Network',
  'sms-certificates': 'Official Certificates',
  'sms-gamification': 'Badges & Gamification',
  'sms-events-facilities': 'Facility Booking',
  'sms-pathways': 'Curricular Pathways',
  'sms-hostel': 'Hostel & Dormitory',
  'sms-inventory': 'Inventory & Asset Tracking',
  'ai-tutor': 'Socratic AI Tutor',
  'EMS Roles & Permissions': 'Dynamic RBAC Matrix',
  'api-tokens': 'API Tokens & Scopes',
  webhooks: 'Webhooks & Telemetry',
  'sms-reports': 'Executive Analytics',
  courses: 'LMS Courses',
...
const TAG_ORDER: string[] = [
  'sms-admissions',
  'sms-matriculation',
  'ems academic curricular bridge',
  'sms-academic',
  'sms-timetable',
  'sms-attendance',
  'sms-gradebook',
...
// API tokens and documentation covers all native LMS and SMS/EMS modules
const ALLOWED_API_TAGS = [
  // SMS Core & Curricular Bridge
  'sms-admissions',
  'admissions',
  'revops',
  'sms-revops',
  ...
  // SMS Safety, Pastoral & Accreditation
  'sms-pastoral',
  'sms-counseling',
  'sms-discipline',
  'sms-cognia',
