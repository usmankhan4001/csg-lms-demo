...
export interface Lead {
  ...
  notes: string
  tags: string[]
  aiScoreBreakdown: LeadScoreBreakdown
...
const INITIAL_LEADS: Lead[] = [
  {
    ...
    parentPhone: '+92 300 8552109',
    parentEmail: 'farooq.ahmed@petroleum.pk',
    targetGrade: 'Grade 11 (Pre-Engineering)',
    targetCampus: 'Islamabad Main Campus',
    previousSchool: 'Beaconhouse Margalla Campus',
    stage: 'inquiry',
    source: 'whatsapp',
    score: 94,
    ...
    notes: 'Inquired via WhatsApp bot about STEM laboratories and transport from Bahria Town Phase 7.',
    tags: ['Pre-Engineering', 'High Intent', 'Transport Needed'],
    aiScoreBreakdown: {
      academicFit: 96,
      budgetMatch: 92,
      parentEngagement: 98,
    ...
    aiRecommendedPitch:
      'Highlight CSG’s Cambridge-certified Physics & Robotics labs and our 94% NUST/GIKI acceptance rate. Offer morning dedicated coaster shuttle from Bahria Phase 7.',
    aiSdrSummary:
      'Father is a senior engineer; student scored 91% in Grade 10 Matriculation. Very high conversion likelihood if STEM lab tour is booked before Friday.',
    activityTimeline: [
      {
        id: 'act-1',
        type: 'whatsapp',
        title: 'WhatsApp Inquiry Received',
        description: 'Parent asked: "Do you have admissions open for F.Sc Pre-Engineering with STEM?"',
      ...
      },
      {
        id: 'act-2',
        type: 'ai_drip',
        title: 'AI Prospectus Dispatched',
        description: 'Sent 2026-2027 Pre-Engineering Prospectus and Fee Schedule via WhatsApp.',
        timestamp: 'Today at 10:16 AM',
        agent: 'AI RevOps Engine',
      },
    ],
  },
  {
    ...
    parentName: 'Dr. Tariq Jamil',
    parentPhone: '+92 321 9844312',
    parentEmail: 'dr.tariq@shifa.com.pk',
    targetGrade: 'Grade 11 (Pre-Medical)',
    targetCampus: 'Islamabad Main Campus',
    previousSchool: 'Army Public School (APS)',
    stage: 'contacted',
    source: 'ads',
    score: 88,
    estimatedTuitionPKR: 45000,
    discountOffered: 15,
    assignedSDR: 'Bilal Hassan',
    lastContact: '2 hours ago',
    createdAt: '2026-09-09',
    notes: 'Father is looking for medical entrance MDCAT preparation integrated curriculum.',
    tags: ['Pre-Medical', 'Doctor Family', 'MDCAT Prep'],
    aiScoreBreakdown: {
      academicFit: 94,
      budgetMatch: 90,
      parentEngagement: 85,
    ...
    aiRecommendedPitch:
      'Present CSG’s integrated MDCAT coaching led by ex-KEMU faculty with weekend mock drills at no additional tuition fee.',
    aiSdrSummary:
      'Dr. Tariq wants guarantees on biology lab equipment and female faculty mentors. Scheduled follow-up call tomorrow at 3 PM.',
    activityTimeline: [
      {
        id: 'act-3',
        type: 'call',
        title: 'Discovery Call Completed',
        description: 'Discussed MDCAT integrated track; father requested scholarship details for 90%+ matric scorers.',
        timestamp: 'Today at 09:30 AM',
        agent: 'Bilal Hassan (SDR)',
      },
    ],
  },
  {
    ...
    parentName: 'Syeda Maryam Shah',
    parentPhone: '+92 333 5129988',
    parentEmail: 'maryam.shah@fintech.com',
    targetGrade: 'Grade 9 (O-Levels)',
    targetCampus: 'Lahore Gulberg Campus',
    previousSchool: 'Roots Millennium Lahore',
    stage: 'tour_booked',
    source: 'web',
    score: 91,
    estimatedTuitionPKR: 52000,
    discountOffered: 0,
    assignedSDR: 'Sara Qureshi',
    lastContact: 'Yesterday',
    createdAt: '2026-09-08',
    notes: 'Campus tour booked for Saturday 11:00 AM at Lahore Gulberg branch.',
    tags: ['O-Levels', 'Cambridge', 'Campus Tour'],
    aiScoreBreakdown: {
      academicFit: 92,
      budgetMatch: 95,
      parentEngagement: 90,
    ...
    aiRecommendedPitch:
      'Showcase the AI-enabled Smart Classrooms, Cambridge British Council affiliation, and Model UN debate society achievements.',
    aiSdrSummary:
      'Mother visited our booth at EduEx Lahore. Highly receptive to technology-integrated learning.',
    activityTimeline: [
      {
        id: 'act-4',
        type: 'tour',
        title: 'Saturday Campus Tour Scheduled',
        description: 'Tour booked with Principal Engr. Ayesha Malik for Sep 13, 11:00 AM.',
        timestamp: 'Yesterday at 04:15 PM',
        agent: 'Sara Qureshi (Admissions)',
      },
    ],
  },
  {
    id: 'lead-104',
    studentName: 'Rayyan Kashif',
    parentName: 'Kashif Mehmood',
    parentPhone: '+92 345 7712390',
    parentEmail: 'kashif.m@consulting.ae',
    targetGrade: 'Grade 12 (A-Levels)',
    targetCampus: 'Islamabad Main Campus',
    previousSchool: 'Froebel’s International',
    stage: 'assessment',
    source: 'referral',
    score: 82,
    estimatedTuitionPKR: 55000,
    discountOffered: 20,
    assignedSDR: 'Ayesha Malik',
    lastContact: '3 hours ago',
    createdAt: '2026-09-07',
    notes: 'Diagnostic test in Advanced Mathematics & Physics cleared with 88% percentile.',
    tags: ['A-Levels', 'STEM', 'Diagnostic Cleared'],
    aiScoreBreakdown: {
      academicFit: 90,
      budgetMatch: 80,
      parentEngagement: 82,
    ...
    aiRecommendedPitch:
      'Offer 20% STEM Merit Scholarship based on A* prediction; emphasize SAT / foreign university counseling desk.',
    aiSdrSummary:
      'Student wants to apply to UK / US universities (Imperial / Waterloo). Needs robust portfolio building.',
    activityTimeline: [
      {
        id: 'act-5',
        type: 'assessment',
        title: 'Entrance Assessment Completed',
        description: 'Diagnostic test score: 88/100. Evaluator: Dr. Fatima Noor.',
        timestamp: 'Today at 11:00 AM',
        agent: 'Academic Testing Desk',
      },
    ],
  },
  {
    id: 'lead-105',
    studentName: 'Eshal Naveed',
    parentName: 'Naveed Akhtar',
    parentPhone: '+92 312 4432190',
    parentEmail: 'naveed.akhtar@gov.pk',
    targetGrade: 'Grade 7 (Middle School)',
    targetCampus: 'Rawalpindi North Campus',
    previousSchool: 'Army Public School Westridge',
    stage: 'offer_sent',
    source: 'walkin',
    score: 79,
    estimatedTuitionPKR: 38000,
    discountOffered: 10,
    assignedSDR: 'Bilal Hassan',
    lastContact: 'Sep 10',
    createdAt: '2026-09-05',
    notes: 'Official Admission Offer letter & 10% Sibling/Govt discount voucher issued.',
    tags: ['Middle School', 'Sibling Discount', 'Offer Sent'],
    aiScoreBreakdown: {
      academicFit: 84,
      budgetMatch: 78,
      parentEngagement: 80,
    ...
    aiRecommendedPitch:
      'Send WhatsApp reminder about fee voucher due date before registration desk deadline.',
    aiSdrSummary:
      'Parent has received the offer letter; waiting on salary cycle on 15th to deposit bank challan.',
    activityTimeline: [
      {
        id: 'act-6',
        type: 'email',
        title: 'Formal Admission Offer Dispatched',
        description: 'Letter #CSG-ADM-2026-0889 sent with PKR 34,200/mo discounted voucher.',
        timestamp: 'Sep 10 at 02:00 PM',
        agent: 'Admissions Directorate',
      },
    ],
  },
  {
    ...
    parentPhone: '+92 301 2289411',
    parentEmail: 'rehman.traders@gmail.com',
    targetGrade: 'Grade 10 (Matriculation)',
    targetCampus: 'Karachi DHA Campus',
    previousSchool: 'St. Patrick’s High School',
    stage: 'enrolled',
    source: 'whatsapp',
    score: 97,
    estimatedTuitionPKR: 42000,
    discountOffered: 15,
    assignedSDR: 'Sara Qureshi',
    lastContact: 'Sep 09',
    createdAt: '2026-09-01',
    notes: 'Challan paid at HBL 1Bill. Student ID CSG-2026-KHI-1092 generated.',
    tags: ['Enrolled', 'Fee Paid', 'Onboarding Complete'],
    aiScoreBreakdown: {
      academicFit: 98,
      budgetMatch: 96,
      parentEngagement: 99,
    ...
    aiRecommendedPitch: 'Welcome onboarding kit dispatched via courier. Invite to Student Orientation.',
    aiSdrSummary: 'Converted within 8 days of initial WhatsApp query. Excellent profile.',
    activityTimeline: [
      {
        id: 'act-7',
        type: 'note',
        title: '1Bill Fee Verification Confirmed',
        description: 'PKR 42,000 admission & term fee settled. Roll # CSG-2026-KHI-1092 assigned.',
        timestamp: 'Sep 09 at 03:45 PM',
        agent: 'Finance Desk',
      },
    ],
  },
  {
    ...
    parentName: 'Ghani-ur-Rehman',
    parentPhone: '+92 334 9912001',
    parentEmail: 'ghani.rehman@export.pk',
    targetGrade: 'Grade 11 (Computer Science)',
    targetCampus: 'Rawalpindi North Campus',
    previousSchool: 'Sadiq Public School',
    stage: 'lost',
    source: 'ads',
    score: 38,
    estimatedTuitionPKR: 45000,
    ...
    notes: 'Family relocated to Peshawar due to government posting. Not enrolling in RWP branch.',
    tags: ['Relocated', 'Disqualified'],
    aiScoreBreakdown: {
      academicFit: 70,
      budgetMatch: 40,
      parentEngagement: 25,
    ...
    aiRecommendedPitch: 'Keep on quarterly alumni/relocation newsletter list for future branch openings.',
    aiSdrSummary: 'Lead closed as lost due to geographic relocation.',
    activityTimeline: [
      {
        id: 'act-8',
        type: 'call',
        title: 'Close Lost Marked',
        description: 'Parent informed transfer to Peshawar. Lead closed gracefully.',
        timestamp: 'Sep 04 at 11:20 AM',
        agent: 'Bilal Hassan',
      },
    ],
  },
